...
export function CustomerAddressForm({ allowCountries, address = {}, formId = 'customerAddressForm', areaId = 'customerAddressForm', customerAddressSchema }) {
    ...
    return (React.createElement(Area, { id: areaId, coreComponents: [
            {
                ...
                props: {
                    address,
                    getErrorMessage: (fieldName, defaultMessage) => getErrorMessage(customerAddressSchema, fieldName, defaultMessage),
                    isFieldRequired: (fieldName, defaultMessage) => isFieldRequired(customerAddressSchema, fieldName, defaultMessage)
                },
                sortOrder: 10
            },
            {
                ...
                props: {
                    ...
                    validationRules: isFieldRequired(customerAddressSchema, 'address_1')
                        ? [
                            {
                                rule: 'notEmpty',
                                message: getErrorMessage(customerAddressSchema, 'address_1', _('Address is required'))
                            }
                        ]
                        : []
                },
                ...
                props: {
                    ...
                    validationRules: isFieldRequired(customerAddressSchema, 'city')
                        ? [
                            {
                                rule: 'notEmpty',
                                message: getErrorMessage(customerAddressSchema, 'city', _('City is required'))
                            }
                        ]
                        : []
                },
