...
`;
export function StepContent({ addShippingAddressApi, shipmentInfo, setShipmentInfo, customerAddressSchema, addresses }) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Form, { method: "POST", action: addShippingAddressApi, id: "checkoutShippingAddressForm", isJSON: true, btnText: _('Continue to payment'), onSuccess: (response) => {
            ...
            React.createElement(CustomerAddressForm, { areaId: "checkoutShippingAddressForm", address: shipmentInfo.address, customerAddressSchema: customerAddressSchema }),
