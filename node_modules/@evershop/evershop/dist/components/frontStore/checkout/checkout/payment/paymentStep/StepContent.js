...
`;
export function StepContent({ cart: { billingAddress, addBillingAddressApi, addPaymentMethodApi }, customerAddressSchema }) {
    var _a, _b;
    ...
    return (React.createElement("div", null,
        React.createElement(Form, { method: "POST", action: addBillingAddressApi, onSuccess: onSuccess, onValidationError: () => setLoading(false), id: "checkoutPaymentForm", submitBtn: false, isJSON: true },
            ...
            useShippingAddress === false && (React.createElement("div", { style: { display: 'block' } },
                React.createElement(CustomerAddressForm, { areaId: "checkoutBillingAddressForm", address: billingAddress || data.cart.shippingAddress, customerAddressSchema: customerAddressSchema }))),
            useShippingAddress === true && (React.createElement("div", { style: { display: 'none' } },
                React.createElement(CustomerAddressForm, { areaId: "checkoutBillingAddressForm", address: data.cart.shippingAddress, customerAddressSchema: customerAddressSchema }))),
