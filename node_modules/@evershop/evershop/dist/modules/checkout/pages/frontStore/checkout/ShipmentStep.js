...
export default function ShipmentStep({ account, cart: { shippingAddress, shippingMethod, addShippingMethodApi, addShippingAddressApi }, setting: { customerAddressSchema } }) {
    ...
    return (React.createElement("div", { className: "checkout-payment checkout-step" },
        React.createElement(StepContent, { step: step, shipmentInfo: shipmentInfo, setShipmentInfo: setShipmentInfo, addShippingAddressApi: addShippingAddressApi, addShippingMethodApi: addShippingMethodApi, customerAddressSchema: customerAddressSchema, addresses: (account === null || account === void 0 ? void 0 : account.addresses) || [] })));
}
