...
export default function PaymentStep({ cart, setting: { customerAddressSchema } }) {
    ...
    return (React.createElement("div", { className: "checkout-payment checkout-step" }, display && (React.createElement(StepContent, { cart: cart, step: step, customerAddressSchema: customerAddressSchema }))));
}
