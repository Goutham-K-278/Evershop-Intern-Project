...
export default function Addresses({ account: { addresses, addAddressApi }, setting: { customerAddressSchema } }) {
                ...
                React.createElement("div", { className: "modal" },
                    React.createElement("div", { className: "bg-white p-8" },
                        ...
                        React.createElement(Form, { id: "customerAddressForm", method: editingAddress.current ? 'PATCH' : 'POST', action: editingAddress.current
                            ...
                            React.createElement(CustomerAddressForm, { address: editingAddress.current, customerAddressSchema: customerAddressSchema })))))))));
}
Addresses.propTypes = {
